...
#if XB_SND_CGU_I2S_CLK_BOOT_INIT
static int default_rate = XB_SND_DEFAULT_SAMPLE_RATE;
#endif
...
#endif // XB_SND_CGU_I2S_CLK_BOOT_INIT
#endif // CONFIG_SOC_T31
	if (mode & CODEC_WMODE) {
...
#if !XB_SND_CGU_I2S_CLK_BOOT_INIT
	clk_set_rate(i2s_dev->i2s_clk, XB_SND_DEFAULT_SAMPLE_RATE*256);
#endif
...
#ifdef CONFIG_SOC_T31
#if !XB_SND_CGU_I2S_CLK_BOOT_INIT
	clk_set_rate(i2s_dev->i2s_clk1, XB_SND_DEFAULT_SAMPLE_RATE*256);
#endif
