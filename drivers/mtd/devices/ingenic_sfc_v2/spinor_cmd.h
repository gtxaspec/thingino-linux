...
#define SPINOR_GB_LOCK		0x7E	/* set Global Block Lock */
#define SPINOR_GB_UNLOCK	0x98	/* set Global Block unLock */
#define SPINOR_IB_LOCK		0x36	/* set Individual Block Lock */
#define SPINOR_IB_UNLOCK	0x39	/* set Individual Block unLock */
#define SPINOR_RB_LOCK		0x3D	/* Read Block Lock status */
...
#define SR3_WPS			(1 << 2)	/* QUAD MODE enable */
...
#endif
#define CONFIG_ERASE_SIZE_4K		(4 * 1024)

#ifdef CONFIG_ZERATUL
#define CONFIG_TAG_OFFSET			(256 * 1024)
#define CONFIG_KERNEL_OFFSET			(768 * 1024)
#endif
