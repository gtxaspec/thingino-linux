...
void sfc_timing(unsigned char sfc_index)
{
...
void ingenic_sfc_init_setup(struct sfc *sfc)
{
	...
	if(sfc->src_clk >= 120 * 4 * 1000000)
		sfc_smp_delay(sfc, DEV_CONF_SMP_DELAY_315);
	else if(sfc->src_clk >= 100 * 4 * 1000000)
		sfc_smp_delay(sfc, DEV_CONF_SMP_DELAY_180);
	else if(sfc->src_clk >= 80 * 4 * 1000000)
		sfc_smp_delay(sfc, DEV_CONF_SMP_DELAY_90);
	else if(sfc->src_clk >= 50 * 4 * 1000000)
		sfc_smp_delay(sfc, DEV_CONF_SMP_DELAY_90);
	else
