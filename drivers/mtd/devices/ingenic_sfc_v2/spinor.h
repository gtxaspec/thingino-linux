...
struct spi_nor_info {
	...
	struct spi_nor_cmd_info sector_erase_4k;
	...
	struct spi_nor_cmd_info status_set;
	struct spi_nor_cmd_info status1_set;
	struct spi_nor_cmd_info status2_set;
	struct spi_nor_cmd_info set_gb_lock;
	struct spi_nor_cmd_info set_gb_unlock;
	struct spi_nor_cmd_info set_ib_lock;
	struct spi_nor_cmd_info set_ib_unlock;
	struct spi_nor_cmd_info get_rb_lock;
...
enum {
	...
	/* 12. need ecter otp mode to set quad mode*/
	NOR_ENTER_OTP,
	...
	/* 13. write status */
	NOR_STATUS_SET_ENABLE,
	NOR_STATUS_SET,
	NOR_STATUS_SET_FINISH,

	/* 14. write status 1*/
	NOR_STATUS_1_SET_ENABLE,
	NOR_STATUS_1_SET,
	NOR_STATUS_1_SET_FINISH,

	/* 15. write status 2*/
	NOR_STATUS_2_SET_ENABLE,
	NOR_STATUS_2_SET,
	NOR_STATUS_2_SET_FINISH,
	...
	NOR_GB_UNLOCK_ENABLE,
	NOR_GB_UNLOCK,
	NOR_GB_UNLOCK_FINISH,
	...
	NOR_IB_UNLOCK_ENABLE,
	NOR_IB_UNLOCK,
	NOR_IB_UNLOCK_FINISH,
