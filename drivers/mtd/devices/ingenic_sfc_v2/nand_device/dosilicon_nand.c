...
static struct device_id_struct device_id[DOSILICON_DEVICES_NUM] = {
	...
	DEVICE_ID_STRUCT(0x75, "DS35Q12C  ", &dosilicon_param[2]),
	DEVICE_ID_STRUCT(0x51, "DS35Q1GD  ", &dosilicon_param[3]),
	DEVICE_ID_STRUCT(0xb2, "DS35Q2GBS  ", &dosilicon_param[4]),
};
