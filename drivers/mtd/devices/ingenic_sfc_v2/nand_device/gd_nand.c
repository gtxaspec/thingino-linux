...
static struct device_id_struct device_id[GD_DEVICES_NUM] = {
	...
	DEVICE_ID_STRUCT(0x01, "F50L1G41LB",&gd_param[10]), //ESMT nand F50L1G41LB
	DEVICE_ID_STRUCT(0x21, "IS37SML01G",&gd_param[11]), //ISSI nand IS37SML01G
	DEVICE_ID_STRUCT(0x91, "GD5F1GM7UE",&gd_param[12]),
	DEVICE_ID_STRUCT(0x95, "GD5F4GM8UE",&gd_param[13]),
};
...
static cdt_params_t *gd_get_cdt_params(struct sfc_flash *flash, uint8_t device_id)
{
	...
	switch(device_id) {
		...
		case 0x91 ... 0x92:
			break;
		case 0x01: // esmt nand F50L1G41LB
			break;
		case 0x21: // ISSI nand IS37SML01G
			break;
		case 0x95:
			break;
		default:
...
__attribute__((unused)) static int32_t gd_get_f0_register_value(struct sfc_flash *flash)
{
