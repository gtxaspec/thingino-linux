...
static struct device_id_struct device_id[XTX_DEVICES_NUM] = {
	...
	DEVICE_ID_STRUCT(0xF1, "TX25G01", &xtx_param[3]),
	DEVICE_ID_STRUCT(0xE4, "FM25S01A", &xtx_param[4]),
	DEVICE_ID_STRUCT(0xE5, "FM25S02A", &xtx_param[5]),
	DEVICE_ID_STRUCT(0xD4, "FM25S01B", &xtx_param[6]),
};
