...
static struct ingenic_sfcnand_base_param micron_param[] = {
...
static struct device_id_struct device_id[] = {
	DEVICE_ID_STRUCT(0x24, "MT29F2G01A", &micron_param[0]),  //esmt nand F50L2G41XA Same ID
//	DEVICE_ID_STRUCT(0x24, "F50L2G41XA", &micron_param[0]),
};
