...
/* UBI Major Device Number Basis */
#define UBI_MAJOR_BASE 250
...
static int uif_init(struct ubi_device *ubi, int *ref)
{
	...
	*ref = 0;
	...
	/* Statically assign device numbers */
	dev = MKDEV(UBI_MAJOR_BASE - ubi->ubi_num,0);
	err = register_chrdev_region(dev, ubi->vtbl_slots + 1, ubi->ubi_name);

	/* Dynamically assign device numbers */
