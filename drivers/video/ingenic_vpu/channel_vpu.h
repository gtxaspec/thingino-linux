...
#define VPU_RET_IVDC_CHECKSUM		0x10000001		//IVDC checksum err
#define VPU_RET_IVDC_SIDNOTATTACH	0x10000002		//IVDC SID not attach err
#define VPU_RET_HERA_BSFULL			0x10000003		//hera bsfull
#define VPU_RET_JPEG_BSLESS			0x10000004		//jpeg bsless
#define VPU_RET_OTHERS				0x10000010		//all the other errs, include host err,timeout,acm err..

#define FRAME_TYPE_IVDC     (3)
#define IVDC_BASE_ADDR      (0x13100000)
#define IVDC_CHECK          (0x3<<30)
enum workphase {
	OPEN	= 0,
	WORKING,
	CLOSE,
...
struct channel_node {
	...
	uint8_t             video_type; /*0: HECV, 1: SVAC2*/
	uint8_t				vtype;
	uint8_t				sensor_id; /* sensor id */
	uint8_t				frame_type; /* frame type,0:non-direct 1:direct */
	uint32_t			hw_time; /* hw time */
};
...
#define IOCTL_CHANNEL_SET_BSFULL_REG	_IOWR(SOC_VPU_MAGIC, 12, struct channel_node)
