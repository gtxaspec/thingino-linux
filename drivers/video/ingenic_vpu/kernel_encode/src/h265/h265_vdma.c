...
void H265E_T32V_SliceInit(struct h265_slice_info *s)//ttt
{
	...
	if(s->frame_type != 2){
		...
		RADIX_GEN_VDMA_ACFG(chn,tmp->RADIX_MCE_BASE_VDMA + RADIX_REG_MCE_PREF_EXPD , 0, (RADIX_MCE_PREF_EXPD_L(64) |
					RADIX_MCE_PREF_EXPD_R(64) |
					RADIX_MCE_PREF_EXPD_D(32) |
					RADIX_MCE_PREF_EXPD_T(32)));
		if(s->buf_share_flag){
