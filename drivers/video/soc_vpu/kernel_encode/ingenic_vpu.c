...
int VPU_Encoder_GetChannelBufferSize(const VPUEncoderAttr *chnAttr)
{
	...
	if (chnAttr->enType == PT_H265) {
		y_rdsize = C_ALIGN(w_align * (h_align + (2 + 1) * 64), 256);
		c_rdsize = C_ALIGN(w_align * (h_align / 2 + (2 + 1) * 32), 256);
		vpu_size = C_ALIGN(VPU_VDMA_SIZE + 256 + (C_ALIGN(chnAttr->picWidth, 32) / 32) * (C_ALIGN(chnAttr->picHeight, 32) / 32) * (124 * 4) + 20 + 2*1024 + 14*256, 256);
		...
		y_rdsize = C_ALIGN(w_align * (h_align + (2 + 1) * 64), 256);
		c_rdsize = C_ALIGN(w_align * (h_align / 2 + (2 + 1) * 32), 256);
		vpu_size = C_ALIGN(VPU_VDMA_SIZE + 256 + (C_ALIGN(chnAttr->picWidth, 16) / 16) * (C_ALIGN(chnAttr->picHeight, 16) / 16) * 121 + 73 + 2*1024 + 14 * 256, 256);
