...
#define JZ_LCD_FPS_MAX  ST7703_SUPPORT_LANE_4_FPS_30
...
static void panel_dev_power_on(struct mipi_dsim_lcd_device *dsim_dev, int power)
{
	...
	//The register just control group A (PA00-PA22) work voltage to 3.3V or 1.8V, the default is 3.3V state
	
	if( 0 <= panel_st7703->bl.gpio <= 22)
	{
		// 1: 1.8V
		// 0: 3.3v
