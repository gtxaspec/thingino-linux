...
static int gpio_wl_power_on = 57; // WL_POWER_ON is input pin of WLAN module
...
#ifdef CUSTOMER_HW_INGENIC
		gpio_direction_output(gpio_wl_power_on, 0);
#endif
...
#ifdef CUSTOMER_HW_INGENIC
		gpio_direction_output(gpio_wl_power_on, 1);
#endif
	}
...
#ifdef CUSTOMER_HW_INGENIC
		err = ingenic_mmc_manual_detect(0, 1);
#endif /* CUSTOMER_HW_INGENIC */
#elif defined(BCMPCIE)
...
#endif /* CUSTOMER_HW_PLATFORM */
#ifdef CUSTOMER_HW_INGENIC
		err = ingenic_mmc_manual_detect(0, 0);
#endif /* CUSTOMER_HW_INGENIC */
#elif defined(BCMPCIE)
