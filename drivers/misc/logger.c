...
int g_logcatprioty = IMP_LOG_LEVEL_INFO;
...
static long logger_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	switch (cmd) {
    case LOGGER_SET_PRIORI:
        copy_from_user(&g_logcatprioty,(void*)arg,sizeof(int));
        ret = 0;
        break;
    case LOGGER_GET_PRIORI:
        copy_to_user((void*)arg,&g_logcatprioty,sizeof(int));
        ret = 0;
        break;
...
static int __init create_log(char *log_name, int size)
{
	...
	log->buffer = buffer;
	if(!strcmp(log_name, "log_radio"))
		log->misc.minor = 72;
	else if(!strcmp(log_name, "log_events"))
		log->misc.minor = 70;
	else if(!strcmp(log_name, "log_system"))
		log->misc.minor = 73;
	else if(!strcmp(log_name, "log_main"))
		log->misc.minor = 71;
