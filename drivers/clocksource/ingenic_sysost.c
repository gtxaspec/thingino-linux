...
CLOCKSOURCE_OF_DECLARE(PRJ007_ost_init, "ingenic,PRJ007-ost", ingenic_ost_init);
#elif defined(CONFIG_SOC_PRJ008)
CLOCKSOURCE_OF_DECLARE(PRJ008_ost_init, "ingenic,PRJ008-ost", ingenic_ost_init);
#endif
