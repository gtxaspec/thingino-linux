...
#if defined(CONFIG_SERIAL_PRJ007_CONSOLE) && defined(CONFIG_MAGIC_SYSRQ)
...
#ifdef CONFIG_SERIAL_PRJ007_CONSOLE
...
#define PRJ007_CONSOLE  &serial_jz47xx_console
#else
#define PRJ007_CONSOLE  NULL
#endif
...
static int serial_jz47xx_probe(struct platform_device *dev)
{
    ...
    sprintf(up->name,"gate_uart%d",dev->id);
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:PRJ007-uart");
