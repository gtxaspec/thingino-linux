...
#if defined(CONFIG_SERIAL_T41_CONSOLE) && defined(CONFIG_MAGIC_SYSRQ)
...
#ifdef CONFIG_SERIAL_T41_CONSOLE
...
#define T41_CONSOLE	&serial_jz47xx_console
#else
#define T41_CONSOLE	NULL
#endif
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:T41-uart");
