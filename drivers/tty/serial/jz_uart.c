...
#if defined(CONFIG_SERIAL_T31_CONSOLE) && defined(CONFIG_MAGIC_SYSRQ)
...
#ifdef CONFIG_SERIAL_T31_CONSOLE
...
#define T31_CONSOLE	&serial_jz47xx_console
#else
#define T31_CONSOLE	NULL
#endif
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:T31-uart");
