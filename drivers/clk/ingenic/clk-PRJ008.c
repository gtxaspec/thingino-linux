...
static struct ingenic_pll_rate_table PRJ008_pll_rate_table[] = {
	...
	PLL_RATE(1026000000, 171, 2, 2, 1),
	PLL_RATE(1000000000, 125, 1, 3, 1),
	PLL_RATE(999000000, 333, 4, 2, 1),
	PLL_RATE(945000000, 315, 4, 2, 1),
...
static struct ingenic_mux_clock PRJ008_mux_clks[] __initdata = {
	MUX(CLK_MUX_SCLKA,	    "sclka",		ingenic_mux_table, mux_table_0, CPM_CPCCR,	    30, 2, CLK_SET_RATE_PARENT),
...
static void __init PRJ008_clk_init(struct device_node *np)
{
	...
	ingenic_clk_sleep_init(reg_base, PRJ008_clk_reg_sleep, ARRAY_SIZE(PRJ008_clk_reg_sleep));
	/* Register Divs */
