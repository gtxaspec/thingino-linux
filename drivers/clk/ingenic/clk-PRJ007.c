...
struct ingenic_clk_reg_sleep PRJ007_clk_reg_sleep[] = {
...
static void __init PRJ007_clk_init(struct device_node *np)
{
	...
	ingenic_clk_sleep_init(reg_base, PRJ007_clk_reg_sleep, ARRAY_SIZE(PRJ007_clk_reg_sleep));
	/* Register Divs */
