...
struct ingenic_clk_reg_sleep PRJ007_clk_reg_sleep[] = {
    ...
    REG_SLEEP(CPM_ISPSCDR,      29, 28, 27, 0),
...
unsigned int PRJ007_nr_clk_reg_sleep = ARRAY_SIZE(PRJ007_clk_reg_sleep);
#endif
...
#ifdef CONFIG_PM
	ingenic_clk_sleep_init(reg_base, PRJ007_clk_reg_sleep, PRJ007_nr_clk_reg_sleep);
#endif
	/* Register Divs */
