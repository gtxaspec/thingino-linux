...
void clk_unprepare(struct clk *clk)
{
    ...
    if(strcmp(clk->core->name, "gate_ahb0") == 0){
		return;
    }
...
static void clk_core_disable(struct clk_core *core)
{
    ...
    if(strcmp(core->name, "gate_ahb0") == 0){
		return;
    }
...
static void clk_change_rate(struct clk_core *core)
{
    ...
    if(!strncmp(core->name, "apll", sizeof("apll")-1) || !strncmp(core->name, "mpll", sizeof("mpll")-1) || !strncmp(core->name, "vpll", sizeof("vpll")-1))
    {
        pll_change = 1;
    }
    if(!pll_change)
