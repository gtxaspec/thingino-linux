...
#define SATA_CTRL_BASE	0xb30d0000
#define SATA_PHY_BASE	(SATA_SNPS_BASE + 0x80000)

#define SATA_CAP			(SATA_CTRL_BASE + 0x000)
#define SATA_GHC			(SATA_CTRL_BASE + 0x004)
#define SATA_IS				(SATA_CTRL_BASE + 0x008)
#define SATA_PI				(SATA_CTRL_BASE + 0x00c)
#define SATA_VS				(SATA_CTRL_BASE + 0x010)
#define SATA_CCC_CTL		(SATA_CTRL_BASE + 0x014)
#define SATA_CCC_PORTS		(SATA_CTRL_BASE + 0x018)
#define SATA_CAP2			(SATA_CTRL_BASE + 0x024)
#define SATA_BISTAFR		(SATA_CTRL_BASE + 0x0a0)
#define SATA_BISTCR			(SATA_CTRL_BASE + 0x0a4)
#define SATA_BISTFCTR		(SATA_CTRL_BASE + 0x0a8)
#define SATA_BISTSR			(SATA_CTRL_BASE + 0x0ac)
#define SATA_BISTDECR		(SATA_CTRL_BASE + 0x0b0)
#define SATA_MEMEDFBSADDRERRDATA	(SATA_CTRL_BASE + 0x0b4)
#define SATA_MEMEDADDRERRINJ		(SATA_CTRL_BASE + 0x0b8)
#define SATA_OOBR					(SATA_CTRL_BASE + 0x0bc)
#define SATA_MEMEDADDRERRDATAU		(SATA_CTRL_BASE + 0x0c0)
#define SATA_DIAGNR3				(SATA_CTRL_BASE + 0x0c4)
#define SATA_GPCR					(SATA_CTRL_BASE + 0x0d0)
#define SATA_GPSR					(SATA_CTRL_BASE + 0x0d4)
#define SATA_CACHECR				(SATA_CTRL_BASE + 0x0d8)
#define SATA_GPARAM3				(SATA_CTRL_BASE + 0x0d8)
#define SATA_TIMER1MS				(SATA_CTRL_BASE + 0x0e0)
#define SATA_MEMDPCR				(SATA_CTRL_BASE + 0x0e4)
#define SATA_GPARAM1R				(SATA_CTRL_BASE + 0x0e8)
#define SATA_GPARAM2R				(SATA_CTRL_BASE + 0x0ec)
#define SATA_PPARAMR				(SATA_CTRL_BASE + 0x0f0)
#define SATA_TESTR					(SATA_CTRL_BASE + 0x0f4)
#define SATA_VERSIONR				(SATA_CTRL_BASE + 0x0f8)
#define SATA_IDR					(SATA_CTRL_BASE + 0x0fc)

//port addr
#define SATA_P_CLB(i)			(SATA_CTRL_BASE + (0x100 + (i * 0x80)))
#define SATA_P_CLBU(i)			(SATA_CTRL_BASE + (0x104 + (i * 0x80)))
#define SATA_P_FB(i)	    	(SATA_CTRL_BASE + (0x108 + (i * 0x80)))
#define SATA_P_FBU(i)			(SATA_CTRL_BASE + (0x10c + (i * 0x80)))
#define SATA_P_IS(i)			(SATA_CTRL_BASE + (0x110 + (i * 0x80)))
#define SATA_P_IE(i)			(SATA_CTRL_BASE + (0x114 + (i * 0x80)))
#define SATA_P_CMD(i)			(SATA_CTRL_BASE + (0x118 + (i * 0x80)))
#define SATA_P_TFD(i)			(SATA_CTRL_BASE + (0x120 + (i * 0x80)))
#define SATA_P_SIG(i)			(SATA_CTRL_BASE + (0x124 + (i * 0x80)))
#define SATA_P_SSTS(i)			(SATA_CTRL_BASE + (0x128 + (i * 0x80)))
#define SATA_P_SCTL(i)			(SATA_CTRL_BASE + (0x12c + (i * 0x80)))
#define SATA_P_SERR(i)			(SATA_CTRL_BASE + (0x130 + (i * 0x80)))
#define SATA_P_SACT(i)			(SATA_CTRL_BASE + (0x134 + (i * 0x80)))
#define SATA_P_CI(i)			(SATA_CTRL_BASE + (0x138 + (i * 0x80)))
#define SATA_P_SNTF(i)			(SATA_CTRL_BASE + (0x13c + (i * 0x80)))
#define SATA_P_FBS(i)			(SATA_CTRL_BASE + (0x140 + (i * 0x80)))
#define SATA_P_DEVSLP(i)		(SATA_CTRL_BASE + (0x144 + (i * 0x80)))
#define SATA_P_DMACR(i) 		(SATA_CTRL_BASE + (0x170 + (i * 0x80)))
#define SATA_P_PHYCR(i) 		(SATA_CTRL_BASE + (0x178 + (i * 0x80)))
#define SATA_P_PHYSR(i) 		(SATA_CTRL_BASE + (0x17c + (i * 0x80)))
