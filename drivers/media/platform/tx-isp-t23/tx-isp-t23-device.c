...
#define MAX_TAG_RISCV_FW_SIZE	(104 * 1024)
#define SENSOR_SETTING_MAX_SIZE	(184 * 1024)
...
#define SENSOR0_SETTING_MAX_SIZE	(180 * 1024)
#define SENSOR1_SETTING_MAX_SIZE	(180 * 1024)
#define SENSOR0_SETTING_OFFSET	    (MAX_TAG_ITER_SIZE_2SENSOR + MAX_TAG_RISCV_FW_SIZE)
