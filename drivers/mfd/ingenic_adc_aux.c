...
#else
#define ingenic_adc_aux_suspend NULL
#define ingenic_adc_aux_resume NULL
#endif
...
restart:
	tmp = wait_for_completion_interruptible_timeout(&ingenic_adc_aux->read_completion, HZ*2);
	if (tmp > 0) {
