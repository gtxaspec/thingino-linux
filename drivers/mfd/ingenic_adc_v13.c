 ...
 * Ingenic PRJ007 ADC device core
 *
...
#else
#define ingenic_adc_suspend NULL
#define ingenic_adc_resume NULL
#endif
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:PRJ007-adc");
