...
#define HASH_FLAGS_NO_PAD		BIT(26)
...
#define HASH_HSBNUM              0x14
#define HASH_HSDI                0x18
#define HASH_HSDO                0x1c
#endif
...
#define HASH_HSSR_ORD		BIT(0)
#define HASH_HSSR_MRD		BIT(1)
...
struct ingenic_hash_dev {
	...
	struct completion hash_completion;
	unsigned int	unaligned_flag;
};

#define MCU_BOOT		0xb3422000
#define DMCS                    0xb3421030

static inline void boot_up_mcu(void)
{
	*(volatile unsigned int *)(DMCS) = 0;
}
