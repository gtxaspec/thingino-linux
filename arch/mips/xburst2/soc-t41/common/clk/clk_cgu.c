 ...
 *          1   , 1       INVALID
 */
	[SELECTOR_A].route = {CLK(STOP) ,CLK(EXT1),CLK(APLL),CLK(INVALID)},
/*
 *         bit31,bit30
 *          0   , 0       STOP
 *          0   , 1       SCLKA
 ...
 *          1   , 1       INVALID
 */
	[SELECTOR_B].route = {CLK(STOP),CLK(SCLKA),CLK(MPLL),CLK(INVALID)},
/*
 *         bit31,bit30
 *          0   , 0       SCLKA
 *          0   , 1       MPLL
 ...
 *          1   , 1       INVALID
 */
	[SELECTOR_D].route = {CLK(SCLKA) ,CLK(MPLL),CLK(EXT1),CLK(INVALID)},
/*
 *         bit31,bit30
 *          0   , 0       SCLKA
 *          0   , 1       MPLL
 ...
 *          1   , 1       EXT1
 */
	[SELECTOR_E].route = {CLK(SCLKA) ,CLK(MPLL),CLK(VPLL),CLK(EXT1)},
/*
 *         bit31,bit30
 *          0   , 0       MSC_MUX
 *          0   , 1       MSC_MUX
...
static struct cgu_clk cgu_clks[] = {
	[CGU_DDR] = 	{ CPM_DDRCDR, 27, 1, 4, SELECTOR_B},
	[CGU_RSA] = 	{ CPM_RSACDR, 27, 1, 4, SELECTOR_C},
	[CGU_VPU] = 	{ CPM_EL200CDR, 27, 1, 4, SELECTOR_C},
	[CGU_MACPHY] = 	{ CPM_MACCDR, 27, 1, 8, SELECTOR_C},
	[CGU_SFC0] = 	{ CPM_SFC0CDR, 27, 1, 8, SELECTOR_C},
	[CGU_SFC1] = 	{ CPM_SFC1CDR, 27, 1, 8, SELECTOR_C},
	[CGU_LCD] = 	{ CPM_LPCDR,  27, 1, 8, SELECTOR_C},
	[CGU_MSC_MUX]=	{ CPM_MSC0CDR, 27, 2, 0, SELECTOR_MSC_MUX},/*TODO:what does it mean?*/
	[CGU_MSC0] = 	{ CPM_MSC0CDR, 27, 4, 8, SELECTOR_E},
	[CGU_MSC1] = 	{ CPM_MSC1CDR, 27, 4, 8, SELECTOR_E},
	[CGU_I2S_SPK] = 	{ CPM_I2STCDR, 29, 0, 20, SELECTOR_C}, /*TODO:check*/
	[CGU_I2S_MIC] = 	{ CPM_I2SRCDR, 29, 0, 20, SELECTOR_C}, /*TODO:check*/
	[CGU_SSI] = 	{ CPM_SSICDR, 27, 1, 8, SELECTOR_C},
	[CGU_CIM] =     { CPM_CIMCDR, 27, 1, 8, SELECTOR_C},
	[CGU_ISPM] = 	{ CPM_ISPMCDR, 27, 1, 4, SELECTOR_C},
	[CGU_ISPS] = 	{ CPM_ISPSCDR, 27, 1, 4, SELECTOR_C},
	[CGU_ISPA] = 	{ CPM_ISPACDR, 27, 1, 4, SELECTOR_C},
	[CGU_BT0] = 	{ CPM_BT0CDR, 27, 1, 8, SELECTOR_C},
	[CGU_PWM] = 	{ CPM_PWMCDR, 27, 1, 8, SELECTOR_C},
	[CGU_LDC] = 	{ CPM_LDCCDR, 27, 1, 8, SELECTOR_C},
};
