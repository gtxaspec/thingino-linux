...
#define DEF_DEVICE(DEVICE, DATA, SIZE)	\
	...
	DEF_DEVICE(&jz_msc0_device, &jz_mmc0_pdata, sizeof(struct jz_sdhci_platdata)),
#endif
#ifdef CONFIG_MMC_SDHCI_MMC1
	DEF_DEVICE(&jz_msc1_device, &jz_mmc1_pdata, sizeof(struct jz_sdhci_platdata)),
#endif
	...
	//DEF_DEVICE(&jz_avpu_irq_device, 0, 0), //zeratul在avpu_main.c里注册
#endif/*CONFIG_AVPU CONFIG_AVPU_DRIVER*/
...
#endif/*CONFIG_VPU_HELIX_NUM*/
#endif/*CONFIG_VPU_HELIX*/

#ifdef CONFIG_VPU_RADIX
#if (CONFIG_VPU_RADIX_NUM >= 1)
	DEF_DEVICE(&jz_vpu_radix0_device, 0, 0),
#endif/*CONFIG_VPU_RADIX_NUM*/
#endif/*CONFIG_VPU_RADIX*/

#endif/*CONFIG_JZ_VPU_IRQ_TEST CONFIG_SOC_VPU*/
...
#endif
#ifdef CONFIG_INGENIC_IPU_V13
	DEF_DEVICE(&jz_ipu_device, 0, 0),
	DEF_DEVICE(&jz_dbox_device, 0, 0),
#endif

#ifdef CONFIG_INGENIC_I2D
	DEF_DEVICE(&jz_i2d_device, 0, 0),
#endif
	...
	DEF_DEVICE(&jz_uart4_device, 0, 0),
#endif
#ifdef CONFIG_SERIAL_T41_UART5
	DEF_DEVICE(&jz_uart5_device, 0, 0),
#endif
	...
	#ifdef CONFIG_SFC0
		DEF_DEVICE(&jz_sfc0_device, &sfc0_info_cfg, sizeof(struct jz_sfc_info)),
	#endif
	#ifdef CONFIG_SFC1
		DEF_DEVICE(&jz_sfc1_device, &sfc1_info_cfg, sizeof(struct jz_sfc_info)),
	#endif
#endif
	...
	DEF_DEVICE(&jz_bscaler_device, 0, 0),
#endif
...
extern struct spi_board_info jz_spi1_board_info[];
...
#ifdef CONFIG_JZ_SPI0
	spi_register_board_info(jz_spi0_board_info, 1);
#endif

#ifdef CONFIG_JZ_SPI1
	spi_register_board_info(jz_spi1_board_info, 1);
#endif
