...
#define GPIO_I2C1_SDA GPIO_PC(19)
#define GPIO_I2C1_SCK GPIO_PC(20)
#endif

#ifdef CONFIG_SOFT_I2C2_GPIO_V12_JZ
#define GPIO_I2C2_SDA GPIO_PC(8)
#define GPIO_I2C2_SCK GPIO_PC(9)
#endif
...
#define GPIO_SPI_SCK  GPIO_PC(2)
#define GPIO_SPI_MOSI GPIO_PC(5)
#define GPIO_SPI_MISO GPIO_PC(4)
#endif
/* ****************************GPIO SPI END********************************** */
...
#ifdef CONFIG_BOARD_TOMCAT
#define GPIO_MMC_CD_N			GPIO_PB(26)
#else
#define GPIO_MMC_CD_N			GPIO_PB(27)
#endif
#define GPIO_MMC_CD_N_LEVEL		LOW_ENABLE
#define GPIO_MMC_PWR			GPIO_PB(20)
...
#define GMAC_PHY_PORT_GPIO GPIO_PB(31)
