...
/**
 * @fn int tx_isp_tuning_set_brightness(int vinum,unsigned char bright)
 *
 * 设置ISP 综合效果图片亮度
 *
 ...
 */
int tx_isp_tuning_set_brightness(int vinum,unsigned char bright);
...
/**
 * @fn int tx_isp_tuning_set_contrast(int vinum,unsigned char contrast)
 *
 * 设置ISP 综合效果图片对比度
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_contrast(int vinum,unsigned char contrast);
...
int tx_isp_tuning_get_contrast(unsigned char *pcontrast);
 ...
 /**
 * @fn int tx_isp_tuning_set_sharpness(int vinum,unsigned char sharpness)
 *
 * 设置ISP 综合效果图片锐度
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_sharpness(int vinum,unsigned char sharpness);
...
/**
 * @fn int tx_isp_tuning_set_saturation(int vinum,unsigned char sat)
 *
 * 设置ISP 综合效果图片饱和度
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_saturation(int vinum,unsigned char sat);
...
/**
 * @fn int tx_isp_tuning_set_ae_it_max(int vinum,unsigned int it_max)
 *
 * 设置AE最大值参数。
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_ae_it_max(int vinum,unsigned int it_max);
...
/**
 * @fn int tx_isp_tuning_set_max_again(int vinum,unsigned int again)
 *
 * 设置sensor可以设置最大Again。
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_max_again(int vinum,unsigned int again);
...
/**
 * @fn int tx_isp_tuning_set_max_dgain(int vinum,unsigned int dgain)
 *
 * 设置ISP可以设置的最大Dgain。
 *
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_max_dgain(int vinum,unsigned int dgain);
