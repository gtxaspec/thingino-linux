...
#define REGISTER_ADDR(addr) ((volatile unsigned long *)(addr))
...
void jzgpio_set_work_voltage(int port,int vol)
{
	gpio_write(port,WORK_VOLTAGE,vol);
}

EXPORT_SYMBOL(jzgpio_set_work_voltage);
