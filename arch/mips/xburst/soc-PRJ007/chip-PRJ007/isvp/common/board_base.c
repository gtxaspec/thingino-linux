...
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART0
	DEF_DEVICE(&jz_uart0_device, 0, 0),
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART1
	DEF_DEVICE(&jz_uart1_device, 0, 0),
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART2
...
#ifdef CONFIG_CRYPTO_DEV_INGENIC_AES
	DEF_DEVICE(&jz_aes_device, 0, 0),
#endif

#ifdef CONFIG_CRYPTO_DEV_INGENIC_SHA
	DEF_DEVICE(&jz_hash_device, 0, 0),
#endif
