...
#ifdef CONFIG_SERIAL_PRJ007_UART0_PB
	UART0_PORTB,
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART0_PC
	UART0_PORTC,
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART1
	UART1_PORTB,
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART2_PB
	UART2_PORTB,
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART2_PA
	UART2_PORTA,
#endif
...
static struct jzdma_platform_data jzdma_pdata = {
	...
	.map = {
		...
		JZDMA_REQ_I2S0,
		JZDMA_REQ_SSLV,
#ifdef CONFIG_SERIAL_PRJ007_UART1_DMA
		JZDMA_REQ_UART1,
		JZDMA_REQ_UART1,
#endif
#ifdef CONFIG_SERIAL_PRJ007_UART0_DMA
		JZDMA_REQ_UART0,
		JZDMA_REQ_UART0,
#endif
		// JZDMA_REQ_SSI1,
...
#ifdef CONFIG_SERIAL_PRJ007_UART2_DMA
	[2] = {
