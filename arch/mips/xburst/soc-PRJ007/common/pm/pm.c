...
int t32_pm_enter(suspend_state_t state)
{
...
static int t32_pm_begin(suspend_state_t state)
{
	printk("t32 suspend begin\n");
	pm_suspend_start_time = jiffies;
	return 0;
}

static void t32_pm_end(void)
{
	printk("t32 pm end!\n");
}
#if defined CONFIG_KP_AXP
static int t32_suspend_prepare(void)
{
	return regulator_suspend_prepare(PM_SUSPEND_MEM);
}
static void t32_suspend_finish(void)
{
...
static const struct platform_suspend_ops t32_pm_ops = {
	.valid		= ingenic_pm_valid,
	.begin		= t32_pm_begin,
	.enter		= t32_pm_enter,
	.end		= t32_pm_end,
#if defined CONFIG_KP_AXP
	.prepare = t32_suspend_prepare,
	.finish = t32_suspend_finish,
#endif
};
