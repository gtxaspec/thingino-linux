...
#define DEF_CLK(N,FLAG)						\
	...
	DEF_CLK(EPLL,		PLL(CPM_CPEPCR)),/*t30 only*/
	...
	DEF_CLK(I2C2,		GATE(9) | PARENT(PCLK)), /*t30 only*/
	...
	DEF_CLK(MSCALER,	GATE(32 + 8) | PARENT(H0CLK)),/*t30 only*/
	DEF_CLK(LDC,		GATE(32 + 9) | PARENT(H0CLK)),/*t30 only*/
