...
#ifdef CONFIG_BOARD_MONKEY /* For Zeratul Camera */
	MSC0_PORTB_4BIT,
	MSC1_PORTC,
#else
...
#if defined(CONFIG_MTD_JZ_SFC_NORFLASH) ||  defined(CONFIG_MTD_JZ_SFC_NORFLASH_MODULE)
...
#ifdef CONFIG_T30_FPGA_TFT_ST7280
        DPU_PORTD_TFT_18BIT,
#endif
...
#ifdef CONFIG_T30_SPI_TFT_ILI9342
