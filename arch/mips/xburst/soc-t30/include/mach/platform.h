...
#define PWM_PORTC_BIT25							\
	{ .name = "pwm4", .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 1 << 25, }
#define PWM_PORTC_BIT26							\
	{ .name = "pwm5", .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 1 << 26, }
#define PWM_PORTC_BIT27							\
	{ .name = "pwm6", .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 1 << 27, }
#define PWM_PORTC_BIT28							\
	{ .name = "pwm7", .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 1 << 28, }
...
#define DPU_PORTD_TFT_RGB_SERIAL_6BIT \
		{ .name = "dpu_tft_6bit",  .port = GPIO_PORT_D, .func =                 GPIO_FUNC_0, .pins = (0x3f << 2 | 0x3 << 8 | 0x3 << 18)}
#define SPI_SLAVER                                                      \
