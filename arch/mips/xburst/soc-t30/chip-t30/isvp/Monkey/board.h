...
#define GPIO_I2C1_SCK GPIO_PC(28)
#endif

#ifdef CONFIG_SOFT_I2C2_GPIO_V12_JZ
#define GPIO_I2C2_SDA GPIO_PB(25)
#define GPIO_I2C2_SCK GPIO_PB(26)
...
#define WL_REG_EN	-1//GPIO_PC(16)
#define WL_MMC_NUM	1 //sdio use MMC1
#define WL_SDIO_SW_EN GPIO_PB(18)
