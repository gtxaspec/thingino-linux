...
#define GPIO_I2C2_SDA GPIO_PA(6)
#define GPIO_I2C2_SCK GPIO_PA(7)
#endif
/* ****************************GPIO I2C END********************************** */
...
#define GPIO_MMC_CD_N			GPIO_PB(29)
...
#define GMAC_PHY_PORT_GPIO GPIO_PB(28)
...
/* ****************************GPIO WIFI START******************************* */
#define WL_WAKE_HOST	GPIO_PA(14)
#define WL_REG_EN	-1//GPIO_PC(9)
#define WL_MMC_NUM	1 //sdio use MMC1
#define WL_SDIO_SW_EN GPIO_PB(23)
...
/* ****************************GPIO LCD START******************************* */
//#define LCD_DISPLAY_EN_GPIO GPIO_PC(25)
//#define LCD_BACKLIGHT_EN_GPIO GPIO_PC(26)
/* ****************************GPIO LCD END********************************* */
