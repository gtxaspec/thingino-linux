...
/*******************************************************************************************************************/
#define UART0_PORTB							\
	{ .name = "uart0_pb", .port = GPIO_PORT_B, .func = GPIO_FUNC_0, .pins = 0x9 << 19, }
#define UART1_PORTB							\
	{ .name = "uart1_pb", .port = GPIO_PORT_B, .func = GPIO_FUNC_0, .pins = 0x3 << 23, }
#define UART2_PORTC							\
	{ .name = "uart2_pc", .port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins = 0x3 << 13, }
#define UART2_PORTA							\
	{ .name = "uart2_pa", .port = GPIO_PORT_A, .func = GPIO_FUNC_2, .pins = 0x3 << 10, }
#define UART1_PORTA							\
	{ .name = "uart1_pa", .port = GPIO_PORT_A, .func = GPIO_FUNC_2, .pins = 0x3 << 6, }
/*******************************************************************************************************************/

#define MSC0_PORTB_4BIT							\
	{ .name = "msc0-pb-4bit",	.port = GPIO_PORT_B, .func = GPIO_FUNC_0, .pins = (0x3f<<0), }
#define MSC1_PORTA_1BIT							\
	{ .name = "msc1-pa-1bit",	.port = GPIO_PORT_A, .func = GPIO_FUNC_3, .pins = (0x300 | 0x30000), }
#define MSC1_PORTA_6BIT							\
	{ .name = "msc1-pa-6bit",	.port = GPIO_PORT_A, .func = GPIO_FUNC_3, .pins = (0xf00 | 0x30000), }
#define MSC1_PORTB							\
...
#define PWM_PORTB_BIT27							\
	{ .name = "pwm2", .port = GPIO_PORT_B, .func = GPIO_FUNC_1, .pins = 1 << 27, }
#define PWM_PORTB_BIT28							\
	{ .name = "pwm3", .port = GPIO_PORT_B, .func = GPIO_FUNC_1, .pins = 1 << 28, }
