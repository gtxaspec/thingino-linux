...
struct jz_gpio_func_def platform_devio_array[] = {
#if !defined(CONFIG_JZMMC_V12_MMC0) || !defined(CONFIG_JZMMC_V12_MMC1)

#ifdef CONFIG_BOARD_INDUS_T31_BGA /* For Zeratul Camera */
	MSC0_PORTB_4BIT,
	MSC1_PORTC,
#endif

#if defined(CONFIG_BOARD_INDUS_T31_QFN)
	MSC0_PORTB_4BIT,
	MSC1_PORTB,
#endif
#if  defined(CONFIG_BOARD_INDUS_T31_QFN_V2)
	MSC0_PORTB_4BIT,
	MSC1_PORTA_6BIT,
#endif
...
#ifdef CONFIG_JZMMC_V12_MMC1_PA_1BIT
	MSC1_PORTA_1BIT,
#endif
	...
	UART0_PORTB,
#endif
#ifdef CONFIG_JZ_PB_UART1_SELECT
	UART1_PORTB,
#endif
#ifdef CONFIG_JZ_PA_UART1_SELECT
	UART1_PORTA,
#endif

#ifdef CONFIG_JZ_PC_UART2_SELECT
	UART2_PORTC,
#endif
#ifdef CONFIG_JZ_PA_UART2_SELECT
	UART2_PORTA,
#endif
...
#if defined(CONFIG_MTD_JZ_SFC_NOR) ||  defined(CONFIG_MTD_JZ_SFC_NOR_MODULE)
...
#if defined(CONFIG_JZ_MAC) || defined(CONFIG_JZ_MAC_MODULE)
	GMAC_PORTB,
#endif
...
#ifdef CONFIG_T31_SPI_TFT_ILI9342
        DPU_PORTD_TFT_RGB_SERIAL_6BIT,
#endif
