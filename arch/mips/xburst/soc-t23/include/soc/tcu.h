...
#define TCU_CHN_NUM 4

#define TCU_TCER   0x10 //R
#define TCU_TCSTR  0x14 //W
#define TCU_TCCLR  0x18 //W
#define TCU_TSR    0x1C //R
#define TCU_TFR    0x20 //R
#define TCU_TFSTR  0x24 //W
#define TCU_TFCLR  0x28 //W
#define TCU_TSSTR  0x2C //W
#define TCU_TMR    0x30 //R
#define TCU_TMSTR  0x34 //W
#define TCU_TMCLR  0x38 //W
#define TCU_TSCLR  0x3C //W
#define TCU_TDFR0  0x40 //RW
#define TCU_TDHR0  0x44 //RW
#define TCU_TCNT0  0x48 //RW
#define TCU_TCSR0  0x4C //RW
#define TCU_TDFR1  0x50 //RW
#define TCU_TDHR1  0x54 //RW
#define TCU_TCNT1  0x58 //RW
#define TCU_TCSR1  0x5C //RW
#define TCU_TDFR2  0x60 //RW
#define TCU_TDHR2  0x64 //RW
#define TCU_TCNT2  0x68 //RW
#define TCU_TCSR2  0x6C //RW
#define TCU_TDFR3  0x70 //RW
#define TCU_TDHR3  0x74 //RW
#define TCU_TCNT3  0x78 //RW
#define TCU_TCSR3  0x7C //RW
...
{
	unsigned char chn;
	enum tcu_func_mode mode;
	enum tcu_clk_src clk_src;
	enum tcu_clk_div division;
};
...
extern int tcu_chn_request(unsigned char chn);
extern int tcu_chn_free(unsigned char chn);
extern void tcu_open_clock(unsigned char chn);
extern void tcu_close_clock(unsigned char chn);
extern int tcu_set_config(struct tcu_config *config);
extern void tcu_set_initl(unsigned char chn, unsigned char initl);
extern void tcu_start_count(unsigned char chn);
extern void tcu_stop_count(unsigned char chn);
extern void tcu_set_count(unsigned char chn, unsigned int value);
extern void tcu_set_tdfr(unsigned char chn, unsigned int value);
extern void tcu_set_tdhr(unsigned char chn, unsigned int value);
extern unsigned int tcu_get_count(unsigned char chn);
#endif
