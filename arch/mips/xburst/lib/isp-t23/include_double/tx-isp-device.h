...
extern char wdr_1_buf_len[255];
extern char dual_sensor_buf_len[255];
extern char sub_sensor_w[255];
extern char sub_sensor_h[255];
...
typedef struct tisp_awb_ct_trend{
	unsigned int trend_array[6];
}awb_ct_trend;
 ...
 */
int tx_isp_set_ev_start(int vinum, int value);
