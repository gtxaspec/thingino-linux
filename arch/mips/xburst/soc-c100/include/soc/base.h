...
#define X2D_IOBASE	    0x13030000		// C100 delete
#define GPU_IOBASE	    0x13040000		// C100 delete
#define FB_IOBASE       0x13050000		// C100 delete
#define LCDC_IOBASE	    0x13050000
#define CIM_IOBASE	    0x13060000		// C100 delete
#define COMPRESS_IOBASE	0x13070000		// C100 delete
#define IPU_IOBASE	    0x13080000
#define GPVLC_IOBASE	0x13090000		// C100 delete
#define MONITOR_IOBASE	0x130f0000		// C100 delete
#define EPDC_IOBASE	    0x130c0000		// C100 delete
#define EPDCE_IOBASE	0x130d0000		// C100 delete
#define DSI_IOBASE      0x13014000		// C100 delete
...
#define	HDMI_IOBASE		0x10180000	// C100 delete
